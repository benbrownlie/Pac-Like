...
void PursueBehavior::update(Agent* owner, float deltaTime)
{
	...
	//Find the direction
	MathLibrary::Vector2 direction = MathLibrary::Vector2::normalize((m_target->getWorldPosition() + m_target->getVelocity()) - owner->getWorldPosition());
...
void PursueBehavior::draw(Agent* owner)
{
